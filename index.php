...
<h2>Cuerpo Academico</h2>
<p></p>

<div class="w3-row"><br>

<div class="w3-third">
  <img src="/TIC/Fotos/ROstos.png" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3>Dr. Rodolfo Ostos</h3>
  <p>PTC</p>
</div>

<div class="w3-third">
  <img src="/TIC/Fotos/VFelix.png" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3>Dr. Vanessa Félix</h3>
  <p>PTC</p>
</div>

<div class="w3-third">
  <img src="/TIC/Fotos/LMena.png" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3>Dr. Luis Javier Mena</h3>
  <p>PTC</p>
</div>
